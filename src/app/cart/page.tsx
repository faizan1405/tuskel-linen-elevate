    ...
    <div className="shell pb-24">
      ...
      {lines.length === 0 ? (
        <div className="mt-12 border border-dashed border-border px-6 py-20 text-center">
          ...
          <Link href="/shop" className="mt-7 inline-block min-h-12 bg-foreground px-8 py-3.5 text-[11px] tracking-[0.18em] text-primary-foreground uppercase">Continue Shopping</Link>
        </div>
      ) : (
        <div className="mt-10 grid gap-12 lg:grid-cols-[1.5fr_1fr] lg:gap-16">
              ...
              <li key={`${l.slug}-${l.size}`} className="flex gap-4 py-6">
                ...
                <div className="flex flex-1 flex-col">
                  <div className="flex justify-between gap-3">
                    <div>
                      <Link href={`/product/${l.slug}`} className="text-[14px] font-medium link-underline">{l.product.name}</Link>
          ...
          <aside className="lg:sticky lg:top-28 lg:h-fit">
            ...
            <div className="mt-7 grid gap-2">
              <Link href="/checkout" className="flex min-h-12 items-center justify-center bg-foreground text-[11px] font-medium tracking-[0.18em] text-primary-foreground uppercase">Proceed to Checkout</Link>
              <Link href="/shop" className="flex min-h-12 items-center justify-center border border-border text-[11px] font-medium tracking-[0.18em] uppercase hover:bg-secondary">Continue Shopping</Link>
            </div>
